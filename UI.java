...
{   
    private JLabel label;//instantiates label
    private JFrame titleS, levelSelectS, easyS, mediumS, hardS;//instantiates frames for different screens
    private JPanel titleP, levelSelectP, easyP, mediumP, hardP;//instantiates panels for different screens
    private JButton play, easyB, mediumB, hardB;//instantiates buttons for different screens

    /**
     * UI constructuors
     * 
     * calls gui method to create different screens
     */
    public UI()
    {
        gui();
    ...
    private void gui()
    {
        ...
        /*
        JButton backLVLSELB = new JButton("Back");
        JButton backEasyB = new JButton("Back");
        JButton backMediumB = new JButton("Back");
        JButton backHardB = new JButton("Back");       
         */
